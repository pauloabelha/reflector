...
in `CAMPAIGN_LOG.md`. The separate `INSIGHTS.md` maintains the living
observation/inference/promotion ledger. Generate a compact control-trace audit
at any checkpoint with:
