...
| Target-only `ls20` run | v94b atomic temporal-resource option, provisional gain | **5.9832589286 for one game** | **2/7** at `[17,240,143,0,0,0,0]`; source-frozen fresh-process run | first autonomous level-2 gain; exact repeat and preservation pending |
