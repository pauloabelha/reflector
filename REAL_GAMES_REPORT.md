...
| Target-only `ls20` run | v97 prospective retry-scoped algebra, provisional gain | **10.7142857143 for one game** | 2/7 at `[17,112,271,0,0,0,0]`; one retry transfer confirmed, level 2 completed 128 actions earlier | first material same-level knowledge-compression gain; exact repeat and preservation pending |
