...
| Target-only `ls20` run | live observational-quotient offspring, provisional | **21.4285714286 for one game** | **3/7** at `[17,112,51,220,0,0,0]`; first two level lengths exactly preserve v97; level 3 completes autonomously in 51 actions | overlapping cropped/full operator views are one causal identity; target repeat and preservation pending |
