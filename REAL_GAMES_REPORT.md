...
| Kaggle notebook artifact | v99l accepted package | — | private notebook `pauloabelha/reflector-arc-agi-3-v99l` version 1 completed and emitted a 2,648-byte `submission.parquet` | exact competition request returned HTTP 400 after v74 consumed the UTC daily allowance; no v99l submission ID |
