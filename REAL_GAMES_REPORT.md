...
| Process-isolated 8-game trace gate | v88 partial bisimulation, trace-only | **5.3189264625 gate mean** | exact v84m score/action preservation; 285/308 prospective predictions confirmed (92.53%), 23 conflicts, no cap failure | online causal quotient validated; no control and no score attribution |
| Process-isolated 8-game causal-frontier gate | v89 predicted-positive frontier, rejected | **5.3189264625 gate mean** | 22 selections across five games; exact v88 score/level-action preservation; changed `ls20` action distribution introduced one new quotient conflict | operative but no goal gradient; accepted v84m remains unchanged |
| Process-isolated 8-game causal-discrimination gate | v90 CEGIS frontier, not promoted | **6.3605931292 gate mean** | 80 queries eliminated 217/470 donor hypotheses (46.17%); exact v84m score/level-action preservation | causal information gain validated, but no downstream task gain |
| Process-isolated 8-game quotient-coverage gate | v91 intervention compression, rejected | **5.3189264625 gate mean** | 368 filters omitted 7,201 redundant concrete tokens and expanded raw-state reach on three games; exact v88 score/level-action preservation | substantial compression without a task predicate; not promoted |
| Black-box `ls20` level-1 diagnosis | phase-conditioned configuration-space plan, not a candidate | — | legal 19-action sequence advances level 1 after operator-induced 3×3 display equality and terminal entry | validates `anchor × phase` planning hypothesis; no autonomous score attribution |
...
| Target-only `ls20` run | v93 contextual phase/topology morphism, rejected | **3.5714285714 for one game** | exact accepted 1/7 vector `[17,383,0,0,0,0,0]`; 109 contextual-planner selections and two observed contextual transitions | representation improved, but latched display-host terminal predicate was false; no second level |
...
| Target-only `ls20` reruns | v98 observational-quotient offspring, provisional | **21.4285714286 for one game** | exact **3/7** at `[17,112,51,220,0,0,0]` twice; first two level lengths preserve v97; level 3 completes autonomously in 51 actions | deterministic target gate passes; overlapping cropped/full operator views are one causal identity; preservation pending |
| Process-isolated accepted-progress preservation gate | v98 observational-quotient offspring, promotion candidate | **35.4601383646 gate mean** | 50 levels in 5,185 actions; all 14 non-`ls20` score/level/action/reset vectors exactly preserve v97 | target attribution and non-regression pass; complete 25-game run pending |
...
| Complete process-isolated 25-game suite | v97 prospective retry-scoped algebra, accepted | **20.8475115902 / 100** | 49/183 levels, 15 games with progress, 3 complete, 9,185 actions; only `ls20` differs from v94b | all promotion, quality, exact-export, smoke, and technical audit gates pass |
...
| Process-isolated accepted-win preservation gate | v97 prospective retry-scoped algebra, promotion candidate | **34.7458526503 gate mean** | 49 levels in 5,185 actions; all 14 non-`ls20` score/action/reset vectors exactly preserve v94b | target attribution and non-regression pass; complete 25-game run pending |
...
| Target-only `tr87` reruns | v84m grouped-dihedral transport, experimental | 71.4285714286 for one game | exact 5/6 vector `[56,45,44,38,55,162]` twice; grouped level completed in 55 actions | deterministic reversed-interface gain; preservation pending |
| Black-box `tr87` level-5 solve | reversed grouped-dihedral transport, not a candidate | — | unique `1→1,1→2,2→1,1→1` partition; derived 19-action program completed level 5 at total action 202 | validates flat-sequence ↔ editable-group isomorphism; autonomous validation pending |
| Target-only `re86` reruns | v84l factor-bundle option, experimental | 77.7777777778 for one game | 7/8 levels at exact `[24,36,56,44,63,57,120,0]` twice; level 7 matched the 120-action composition | deterministic painted factor-bundle gain; preservation pending |
| Black-box `re86` level-7 exact-horizon solve | factor-bundle paint/deformation planning, not a candidate | — | exact-span 38 + 30 + 50 action options plus two focus transfers completed level 7 at total action 400 | first valid 7/8 trajectory; autonomous validation pending |
| Black-box `re86` level-7 extended-horizon solve | factor separation + paint-state recombination, not a candidate | — | fully occupied 56 + 32 + 50 action options plus two focus transfers completed level 7 at total action 420 | validates construction; must compress 40 actions for official horizon |
| Target-only `re86` run | v84k conserved factor/obstacle options, experimental | 58.3333333333 for one game | 6/8 levels at `[24,36,56,44,63,57,120,0]`; level 6 matched the predicted 57 actions | first autonomous differential-factor and conserved-loop gain; repeat pending |
| Black-box `re86` level-6 diagnostic | conserved factor/obstacle planning, not a candidate | — | public-wrapper geometry-derived program solved level 6 in 57 actions after the five-level prefix | shared actions on segment products and conserved-perimeter loops; autonomous validation pending |
| Black-box `re86` level-5 diagnostic | joint latent-color exact cover, not a candidate | — | public-wrapper paint-aware program solved level 5 in 63 actions after the v84h four-level prefix | unique compositional target found; autonomous validation pending |
| Target-only `re86` run | v84j committed composite option, experimental | 41.6666666667 for one game | 5/8 levels at `[24,36,56,44,63,177,0,0]`; level 5 matched the predicted 63 actions | first autonomous latent-color coproduct and atomic-option gain; repeat pending |
| Target-only `re86` run | v84i composite reference option, experimental | 27.7777777778 for one game | remained 4/8 at `[24,36,56,44,240,0,0,0]`; all three CSP options grounded; 63 constellation selections | rejected execution trace: five paired-object actions interrupted the committed plus option |
| Target-only `re86` run | v84h paint-state option, experimental | 27.7777777778 for one game | 4/8 levels at `[24,36,56,44,240,0,0,0]`; level 4 matched the predicted 44 actions | first validated planning over `(anchor,color)`; repeat and preservation pending |
| Target-only `re86` run | v84g cross-color positional option, experimental | 16.6666666667 for one game | 3/8 levels; all 24 level-4 option actions executed | rejected positional endpoint; swatches are causal paint transitions |
| Target-only `re86` run | v84f product exact cover, experimental | 16.6666666667 for one game | 3/8 levels at `[24,36,56,284,0,0,0,0]`; level 3 matched the predicted 56 actions; zero quarantines/conflicts | first validated same-color product-object gain; repeat pending |
